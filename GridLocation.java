...
/**
 * Represents a single grid location (one (row,column) position)
...
public class GridLocation extends JPanel {
    ...
    /**
     * Returns true if location contains a predator, false otherwise
    ...
    /**
     * Determines if two locations represent the same position within the 2D grid
    ...
    /**
     * This method is used to help ensure that the size of the grid location is always a very specific size
     */
    @Override
